...
export function VejeteAl({ VejeteLost = false, ...props}) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/models-3d/VejeteAl.glb')
 ...
 useEffect(() => {
  ...
  if (VejeteLost && actions.Flow) {
    actions.Flow.reset().play();
  } else if (actions.Nervioso) {
    actions.Nervioso.reset().play();
  }
